...
<head>
    ...
    <link href="<?= base_url('assets/beranda'); ?>/vendor/animate.css/animate.min.css" rel="stylesheet">
        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-10 d-flex align-items-center justify-content-end">
                    ...
                    <h1 class="logo mr-auto"><a href="#">Masjid Asy-syuhada</a></h1>
                    ...
                    <nav class="nav-menu d-none d-lg-block">
                        <ul>
                            ...
                            <li><a href="#">Info kas masjid</a></li>
