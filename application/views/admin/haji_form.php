        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0"><i class="fas fa-home"></i> From tambah nasabah haji</h6>
                </div>
            </div>
            <div>
                <form action="<?= base_url('idul_adha/tambah_nasabah_haji_aksi'); ?>" method="POST">
                    <div class="row">
                        <div class="col-md-6">
